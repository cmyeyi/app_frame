...
public class DrawableRadioButton extends RadioButton {
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        widthPx = ta.getDimensionPixelSize(R.styleable.DrawableTextView_drawableWidth, -1);
        heightPx = ta.getDimensionPixelSize(R.styleable.DrawableTextView_drawableHeight, -1);
